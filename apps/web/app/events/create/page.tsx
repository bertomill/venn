        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-[#2a2a2a] rounded-2xl p-8 w-full max-w-md mx-4 shadow-2xl border border-white/10">
            ...
            <div className="space-y-4">
              ...
              <button className="w-full py-3 bg-white/10 border border-white/10 text-white rounded-xl font-medium hover:bg-white/20 transition-all flex items-center justify-center gap-2">
